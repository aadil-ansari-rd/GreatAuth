        ...
        <div className='w-full flex justify-between items-center p-4 sm:p-6 sm:px-24 absolute top-0'>
            ...
            {userData && isLoggedin ? (
                <div className='flex w-8 h-8 justify-center items-center rounded-full bg-black text-white relative group'>
                    <h3>{userData.name[0].toUpperCase()}</h3>
                ...
                :
                (
                    <button onClick={() => navigate('/login')} className='flex items-center gap-2 border border-grayy-500 rounded-full px-6 py-2 text-gray-800 hover:bg-gray-100 transition-all '>
